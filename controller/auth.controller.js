...
const verifyEmail = require("../utility/verifyEmail");
...
const login = asyncHandler(async (req, res, next) => {
 ...
 res.send('Login is successfull').status(200);
});
...
const verificationEmail = asyncHandler(async (req, res, next) => {
  ...
  //sendTokenResponse(user, 200, res);
  res.send('Verification is successfully').status(200);
});
...
const updatePassword = asyncHandler(async (req, res, next) => {
  ...
  //sendTokenResponse(user, 200, res);
  res.send('update is successfully').status(200);
});
...
const forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  try {
    const resetUrl = `https://kenneth-uche-shop.herokuapp.com/resetPassword/?token=${resetToken}`;
